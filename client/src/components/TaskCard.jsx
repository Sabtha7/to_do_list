...
const TaskCard = ({ task, onDelete, onComplete }) => {
  return (
    <article
      className={`rounded-2xl border bg-white p-4 shadow-soft transition duration-300 hover:-translate-y-0.5 hover:shadow-lg ${
        isOverdue(task) ? "border-red-200" : "border-blue-100"
      }`}
    >
      ...
      <div className="flex items-center justify-end gap-2">
        {task.status !== "completed" && (
          <button
            ...
            className="inline-flex items-center gap-1 rounded-lg bg-emerald-500 px-3 py-2 text-xs font-semibold text-white transition hover:bg-emerald-600"
          >
        ...
        <button
          ...
          className="inline-flex items-center gap-1 rounded-lg bg-rose-500 px-3 py-2 text-xs font-semibold text-white transition hover:bg-rose-600"
        >
